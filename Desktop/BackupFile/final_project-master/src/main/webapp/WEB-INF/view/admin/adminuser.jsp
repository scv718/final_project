...
.myButton {
	...
	background:linear-gradient(to bottom, #fafafa 5%, #d6d2d6 100%);
...
.myButton:hover {
	background:linear-gradient(to bottom, #d6d2d6 5%, #fafafa 100%);
...
<body>
    ...
    <div class="wrapper">
        ...
        <div id="content">
           ...
           <h2 align="center">고객목록조회(정보변경/삭제)</h2>
           <br><br>
    ...
    <table id="myTable" class="display table" width="100%">
      ...
      <td>${users.id}</td>
      <td>${users.m_birth}</td>
      <td><input type="text" id="#updateUser" value="${users.m_name}"></td>
      <td><input type="text" value="${users.m_email}"></td>
      <td>${users.login}</td>
      <td>${users.level}</td>
	  <td>
	  	<input class="myButton1" type="button" value="수정" onclick="idUpdate('${users.id} %>');">
      	<input class="myButton2" type="button" value="삭제" onclick="idDelete('${users.id}');">
      </td>
       </tr>            
       </c:forEach>
       </tbody>
