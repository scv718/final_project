...
public class IamportController {
	...
	@ResponseBody
	public int userCertification(@RequestBody HashMap<String, Object> param, HttpServletRequest request,
			HttpServletResponse response, HttpSession session, Model model, UserVO vo) throws IOException {
	...
	public String userCertificationget(HttpServletRequest request, HttpServletResponse response, HttpSession session,
			Model model, UserVO vo) throws IOException {
		Map<String, String> map = new HashMap<String, String>();
		String token = getImportToken();
		HttpClient client = HttpClientBuilder.create().build();
	...
	@ResponseBody
	public int userPhoneCertification(@RequestBody HashMap<String, Object> param, HttpServletRequest request,
			HttpServletResponse response, HttpSession session, Model model, UserVO vo) throws IOException {
	...
	@ResponseBody
	public int forgotPw(@RequestBody HashMap<String, Object> param, HttpServletRequest request,
			HttpServletResponse response, HttpSession session, Model model, UserVO vo) throws IOException {
		Map<String, String> map = new HashMap<String, String>();
		String token = getImportToken();
		HttpClient client = HttpClientBuilder.create().build();
	...
	public String forgotPwget(HttpServletRequest request, HttpServletResponse response, HttpSession session,
			Model model, UserVO vo) throws IOException {
		Map<String, String> map = new HashMap<String, String>();
		String token = getImportToken();
		HttpClient client = HttpClientBuilder.create().build();
	...
	public String mobilepay(HttpServletRequest request, HttpServletResponse response, Model model, OrderVO ovo,
...
//      ovo.setOrd_phone(콜);
	...
	public String payment1(HttpServletRequest request, HttpServletResponse response, Model model, OrderVO ovo,
			AddressVO avo, SubscribeVO svo, WineVO vo, UserVO uvo, HttpSession session) throws IOException {
	...
	public String mobilepay1(HttpServletRequest request, HttpServletResponse response, Model model, OrderVO ovo,
			AddressVO avo, SubscribeVO svo, WineVO vo, UserVO uvo, HttpSession session) throws IOException {
		System.out.println("모바일 구독");
...
//		}
		...
		String formatedNow = now.format(formatter);
		 ...
		 if (w_no.equals("w_no=999")) {
				...
				System.out.println(vo.getW_no() + " 와인테이블 번호");
				System.out.println(ovo.getW_no() + " 오더데이블 번호");
				System.out.println(ovo.getW_nm_k() + " 패키지 명");
				System.out.println(ovo.getW_nm_e() + " 와인이름 영어");
