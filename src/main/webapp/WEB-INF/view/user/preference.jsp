...
<input type="range" class="form-range" min="1" max="5" id="s_sweet" name = "s_sweet">
<br>
<label for="customRange2" class="form-label">바디(Body)</label>
<div>와인의 바디감은 와인을 머금었을 때 입안에서 느껴지는 '묵직함' 을 의미합니다. </div>
<input type="range" class="form-range" min="1" max="5" id="s_body" name = "s_body">
<br>
...
<input type="range" class="form-range" min="1" max="5" id="s_acidity" name = "s_acidity">
<br>
