...
<div class="row featurette" id ="pack">
		...
		<div class="col-md-5"id="col-D-5">
			<img id="imgsubcss"style="margin-right: 55;border-radius: 8%"class="featurette-image img-responsive center-block"
	...
	<div class="row featurette" id ="pack">
		...
		<div class="col-md-5"id="col-D-5">
			<img id="imgsubcss"style="border-radius: 8%"class="featurette-image img-responsive center-block"
...
<div class="row featurette" id ="pack">
		<div class="col-md-7 " id="aa">
			...
			<div class="lead">
			<h3>구독자 분들의 취향을 최대한 반영하여 매월 3가지의 와인을 배송해 드립니다.<br>
				배송되는 와인은 레드 2개, 화이트 1개로 구성되어 있습니다. 와인을 처음 접하는 분들과 와인을 잘 모르시지만 깊게 알아가고 싶은 분들을 위한 패키지입니다.<br>
				취향을 많이 가리거나 부담되는 와인은 선별하지 않기에 위와 같은 사항인 구독자 분들께 안성 맞춤입니다!!</h3>
			</div>
		</div>
		<div class="col-md-5"id="col-D-5">
	...
	<div class="row featurette" id ="pack">
		<div class="col-md-7 col-md-push-5" id="aa">
			...
			<div class="lead">
			<h3>구독자 분들의 취향을 최대한 반영하여 매월 3가지의 와인을 배송해 드립니다.<br>
			    배송되는 와인의 레드 2개 , 화이트 1개로 구성되어 있습니다. 나의 취향을 잘모르시는 분들이나 여러 분야의 와인을 맛보고 견식을 높이고 싶은 분들을 위한 패키지로<br>
				좋아하는 취향의 와인과 여러 분야의 와인을 맛보고 싶은 분들께 안성 맞춤입니다!!</h3>
			</div>
		</div>
		<div class="col-md-5"id="col-D-5">
	...
	<div class="row featurette" id ="pack">
		...
		<h1 class="featurette-heading">
			...
			<div class="lead">
			<h3>구독자 분들의 취향을 최대한 반영하여 매월 3가지의 와인을 배송해 드립니다.<br>
				배송되는 와인의 레드 1개 , 화이트 1개 , 로제 1개로 구성되어 있습니다.
				와인을 사랑하고 좋아하는 분들을 위한, 다양성 있는 맛과 풍미가 준비된 패키지로<br>
				매월 자신의 취향으로 엄선된 고품격 와인과 새로운 취향에 눈을 뜨고 싶은 분들에게 안성 맞춤입니다!!</h3>
			</div>
		</div>
