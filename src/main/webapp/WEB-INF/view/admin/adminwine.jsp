...
<!-- Our Custom CSS -->
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/adminmain.css">
	...
	<div class="wrapper">
		...
		<nav id="sidebar">
			...
			<ul class="list-unstyled components">
				<li class="active"><a href="#homeSubmenu"
					data-toggle="collapse" aria-expanded="true" class="dropdown-toggle"><strong>데이터정보</strong></a>
		...
		<div id="content">
         ...
         <tr style="text-align: center">
							...
							<td>${wine.country}</td>
							<td>${wine.since}</td>
							<td><input style="width: 30px;" name="quantity"
								id="quantity${wine.w_no}" value="${wine.quantity}"></td>
							<td><input style="width: 80px;" name="w_price"
								id="w_price${wine.w_no}" value="${wine.w_price}"></td>
							<td>${wine.w_sales}</td>
							<td><a style="color: white" class="myButton1"
								onclick="{updateWine(${wine.w_no})}">수정</a> <a
								style="color: white" class="myButton2" id="id"
								onclick="if(confirm('정말 삭제하시겠습니까?')){deleteWine('${wine.w_no}')}">삭제</a></td>
						</tr>   
        </c:forEach>
				</tbody>
			</table>
