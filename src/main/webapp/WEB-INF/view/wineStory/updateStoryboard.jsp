	  ...
	  <form action="admin_updateStory1_c.wp" method="post" enctype="multipart/form-data">   
			<div id="reviewcontent">
				<div id="review-top">
					...
					<h4 style="text-align: center;"> 소제목 변경  <br>
						<input type="text" name="story_semi_title" id="updatetitle" placeholder="소제목" value="${story1_c_b.story_semi_title}">
					</h4>
				</div>
