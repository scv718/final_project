	...
	<div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
		...
		<div class="s_t col-sm-12">
				...
				<img class="bd-placeholder-img" id="t1"
					src="${pageContext.request.contextPath}/resources/img/story/${story2_t.story_back_img}"></div>
				<div class="s_t_c">
				<h1>${story2_t.story_title}</h1>
				</div><br><br><hr>
			</div>
			<c:forEach items="${story2_c}" var="story2" varStatus="status">
				<div>
					<h2 class="fw-normal">${story2.story_semi_title}</h2>
					<br>
					<hr>
